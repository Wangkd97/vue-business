  ...
  <div class="app-init detail-page">
    ...
    <div class="app-init scroll-box footer-hack">
      <div class="banner">
        ...
        <span class="back iconfont icon-backer" "></span>
      </div>
      ...
      <div class="content">
        ...
        <div class="title-box">
          ...
          <div class="press">
            ...
            <span class="tips" v-for="(target, index) in info.tips" :key="goodsindex">{{ target }}</span>
          </div>
        </div>
        ...
        <div class="touch-item-box">
          ...
          <div class="touch-item">
            ...
            <span v-for="(target, index) in info.address" :key="goodsindex">{{ target }}</span>
          </div>
        </div>
        ...
        <div class="p-box">
          <img v-for="(target, index) in info.pBox" :key="goodsindex" v-lazy="target" alt="">
        </div>
